...
const Board = ({ values, numbers, setNumbers, time, count, setCount, setTime, setTreasure, treasure , select }) => {
    ...
    return (
        <div class="main-div">
            ...
            <div class='component'>
            {startt && time > 0 ? <div class="timer-div mob" id='time'>
                ...
                {startt && time > 0 ? <div class="timer-div desk" id='time'>
                {select && <p class="timer"><span>{time}</span></p>}
                </div> : <></>}
            </div>
        </div>
